    ...
    $.fn.bcalendar = function(option) {
		...
		function dayshowQuick(e, data) {
            ...
            if (data != null) {
                if (option.quickDeleteUrl != "" && data[8] == 1 && option.readonly != true) {
                    var csbuddle = '<div id="bbit-cs-buddle" style="z-index: 180; width: 400px;visibility:hidden;" class="bubble"><table class="bubble-table" cellSpacing="0" cellPadding="0"><tbody><tr><td class="bubble-cell-side"><div id="tl1" class="bubble-corner"><div class="bubble-sprite bubble-tl"></div></div><td class="bubble-cell-main"><div class="bubble-top">ssss</div><td class="bubble-cell-side"><div id="tr1" class="bubble-corner"><div class="bubble-sprite bubble-tr"></div></div>  <tr><td class="bubble-mid" colSpan="3"><div style="overflow: hidden" id="bubbleContent1"><div><div></div><div class="cb-root"><table class="cb-table" cellSpacing="0" cellPadding="0"><tbody><tr><td class="cb-value"><div class="textbox-fill-wrapper"><div class="textbox-fill-mid"><div id="bbit-cs-what" title="'
        ...
        function dayshow(e, data) {
			 ...
			 /* if (!option.EditCmdhandler) {
                        ...
                        if (option.EditCmdhandler && $.isFunction(option.EditCmdhandler)) {
                            option.EditCmdhandler.call(this, [data[0], '', dateFormat.call(data[2], i18n.xgcalendar.dateformat.fulldayvalue + " HH:mm"), dateFormat.call(data[3], i18n.xgcalendar.dateformat.fulldayvalue + " HH:mm"), data[4]]);
                        }
        ...
        function quickadd(start, end, isallday, pos) {
		  ...
		  $("#bbit-cal-allday").val(isallday ? "1" : "0");
				if (!option.EditCmdhandler) {
                        ...
                        if (option.EditCmdhandler && $.isFunction(option.EditCmdhandler)) {
                            option.EditCmdhandler.call(this, ['0', '',dateFormat.call(start, i18n.xgcalendar.dateformat.fulldayvalue + " HH:mm"), dateFormat.call(end, i18n.xgcalendar.dateformat.fulldayvalue + " HH:mm"), isallday ? "1" : "0"]);
                        }
                        $("#bbit-cal-buddle").css("visibility", "hidden");
                        realsedragevent();
                    }
            ...
            if (buddle.length == 0) {
                ...
                temparr.push('<td class="bubble-cell-main"><div class="bubble-top">dddd</div><td class="bubble-cell-side"><div id="tr1" class="bubble-corner"><div class="bubble-sprite bubble-tr"></div></div>  <tr><td class="bubble-mid" colSpan="3"><div style="overflow: hidden" id="bubbleContent1"><div><div></div><div class="cb-root">');
