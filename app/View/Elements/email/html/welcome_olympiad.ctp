...
<br /><br />
We would like to re-iterate that you have paid for ""<b><?php echo $packageName;?></b>" of class <b><?php echo $grade;?></b> starting from  "<?php echo $data['startDate'];?>" & valid up to 31st March 2010, this pack includes:
<br /><br />
1. Access to Practice Test Papers & Weekly Release of Model Test Papers before Exam.
<br /><br />
2. This access will be available till 31st March 2010 and is independent of your school session period.
<br /><br />
