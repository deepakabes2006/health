...
We would like to re-iterate that you have paid for "<?php echo $packageName;?>" of class <?php echo $grade;?> starting from  "<?php echo $data['startDate'];?>" & valid up to 31st March 2010, this pack includes:
