...
<head id="Head1">
    ...
    <link href="/css/calender/calendar.css" rel="stylesheet" type="text/css" /> 
    <link href="/css/calender/dp.css" rel="stylesheet" type="text/css" />   
    <link href="/css/calender/alert.css" rel="stylesheet" type="text/css" /> 
	...
	<script src="/js/calender/jquery.alert.js" type="text/javascript"></script>    
    <script src="/js/calender/jquery.ifrmdailog.js" defer="defer" type="text/javascript"></script>
    <script src="/js/calender/wdCalendar_lang_US.js" type="text/javascript"></script>    
    <script src="/js/calender/jquery.calendar.js" type="text/javascript"></script>   
    <script type="text/javascript">
        $(document).ready(function() {     
           var view="week";          
            ...
            function Edit(data)
            {
               var eurl="/doctors/edit_calendar/{0}/?id={0}&start={2}&end={3}&isallday={4}&title={1}";   
                if(data)
                {
